                ...
                <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      <p className="font-medium">{(student as any).fatherPhone || 'N/A'}</p>
                    </div>

                    <div>
                      <p className="text-sm text-gray-600">পিতার পেশা</p>
                      <p className="font-medium">{(student as any).fatherOccupation || 'N/A'}</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      <p className="font-medium">{(student as any).motherPhone || 'N/A'}</p>
                    </div>

                    <div>
                      <p className="text-sm text-gray-600">মাতার পেশা</p>
                      <p className="font-medium">{(student as any).motherOccupation || 'N/A'}</p>
                    </div>
                  </div>
                </div>
