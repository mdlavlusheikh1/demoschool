...
function StudentEditPage() {
  ...
  const handleSaveStudent = async () => {
    ...
    try {
      ...
      if (student.emergencyContact) updateData.emergencyContact = student.emergencyContact;
      if (student.emergencyRelation) updateData.emergencyRelation = student.emergencyRelation;
    ...
    <div className="h-screen bg-gray-50 flex overflow-hidden">
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <div className="flex-1 p-4 lg:p-6 bg-gray-50 overflow-y-auto">
          ...
          <div className="mb-6">
            <button
              onClick={() => router.push(`/teacher/students/view?id=${studentId}`)}
          ...
          {studentLoading ? (
            ...
            <div className="max-w-4xl mx-auto space-y-6">
              ...
              <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                <div className="flex items-center justify-between mb-6">
                  ...
                  <div className="flex space-x-3">
                    <button
                      onClick={() => router.push(`/teacher/students/view?id=${student.uid}`)}
              ...
              <div className="space-y-6">
                ...
                <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                  <h3 className="text-lg font-semibold text-gray-900 mb-6">পিতার তথ্য</h3>
                ...
                <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                  <h3 className="text-lg font-semibold text-gray-900 mb-6">মাতার তথ্য</h3>
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div>
                ...
                <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                  <h3 className="text-lg font-semibold text-gray-900 mb-6">জরুরী যোগাযোগ</h3>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                      <label className="block text-sm font-medium text-gray-700 mb-2">জরুরী ফোন</label>
                      <input
                        type="tel"
