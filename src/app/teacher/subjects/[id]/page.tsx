...
function SubjectDetailPage() {
  ...
  if (loading) {
    return (
      <TeacherLayout title="বিষয়ের বিস্তারিত" subtitle="লোড হচ্ছে...">
  ...
  if (!subject) {
    return (
      <TeacherLayout title="বিষয়ের বিস্তারিত" subtitle="পাওয়া যায়নি">
  ...
  return (
    <TeacherLayout title={subject.name} subtitle="বিষয়ের বিস্তারিত">
