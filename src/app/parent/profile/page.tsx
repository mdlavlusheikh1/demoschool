...
export default function ProfilePage() {
  ...
  if (loading) {
    return (
      <ParentLayout title="প্রোফাইল" subtitle="আপনার প্রোফাইল দেখুন এবং আপডেট করুন">
  ...
  return (
    <ParentLayout title="আমার প্রোফাইল" subtitle="আপনার ব্যক্তিগত তথ্য দেখুন এবং আপডেট করুন">
      <IKContext
        publicKey={publicKey}
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-8">
          <div className="flex items-center space-x-6">
            ...
            <div className="relative">
              <div className="w-32 h-32 rounded-full bg-gradient-to-br from-blue-600 to-purple-600 flex items-center justify-center overflow-hidden">
              ...
              <label className="absolute bottom-0 right-0 bg-blue-600 text-white p-2 rounded-full cursor-pointer hover:bg-blue-700 transition-colors">
                ...
                <IKUpload
                  ...
                  tags={['profile', 'parent', user?.uid || 'unknown']}
